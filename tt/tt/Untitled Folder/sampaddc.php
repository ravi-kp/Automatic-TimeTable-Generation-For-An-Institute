...
<tr><td><input type="checkBox" name="myCheck_first" id="myCheck_first" onclick="myFunc(),onlyOne1(this)" value="Core_Course" <?php if(isset($_POST['myCheck_first'])) echo "checked='checked'"; ?> />Core_Course
	...
	<option>57</option>
        <option>68</option>
					 ...
					 <td> <input type="checkBox" name="myCheck_second" id="myCheck_second"  onclick="myFunction(),onlyOne1(this)" value="Elective_Course" <?php if(isset($_POST['myCheck_second'])) echo "checked='checked'"; ?>/>Elective_Course
					   <p id="text2" style="display:none"><input type="checkbox" id="option1" name="option1" value="5" <?php if(isset($_POST['option1'])) echo "checked='checked'"; ?>/>5</p>
					   <p id="text3" style="display:none"><input type="checkbox" id="option2" name="option2" value="6" <?php if(isset($_POST['option2'])) echo "checked='checked'"; ?>/>6</p>
					   <p id="text4" style="display:none"><input type="checkbox" id="option3" name="option3" value="7" <?php if(isset($_POST['option3'])) echo "checked='checked'"; ?>/>7</p>
                       <p id="text5" style="display:none"><input type="checkbox" id="option4" name="option4" value="8" <?php if(isset($_POST['option4'])) echo "checked='checked'"; ?>/>8</p> </td>                    
					   <script>
function myFunc() {
					...
					<tr>
                     <td>Is It Lab(YES/NO):</td>
                      <td>
						...
						<input type="checkbox" name="myCheck_fourth" id="myCheck_fourth"  onclick="onlyOne2(this)" value="n" <?php if(isset($_POST['myCheck_fourth'])) echo "checked='checked'"; ?>/>n</input>
						<p id="text6" style="display:none"><input type="checkbox" id="option5" name="option5" value="D1" <?php if(isset($_POST['option5'])) echo "checked='checked'"; ?>/>D1</p>
						<p id="text7" style="display:none"><input type="checkbox" id="option6" name="option6" value="D2" <?php if(isset($_POST['option6'])) echo "checked='checked'"; ?>/>D2</p>
						<p id="text8" style="display:none"><input type="checkbox" id="option7" name="option7" value="D3" <?php if(isset($_POST['option7'])) echo "checked='checked'"; ?>/>D3</p>
    ...
    checkboxes.forEach((item) => {
        if (item !== checkbox) item.checked = false
                  ...
                  <tr>
                     ...
                     <td> <input type="checkbox" id="myCheck_prefer1" name="myCheck_prefer1" onclick="onlyOne(this)" value="0" <?php if(isset($_POST['myCheck_prefer1'])) echo "checked='checked'"; ?>/>0
                       <input type="checkbox" id="myCheck_prefer2"  name="myCheck_prefer2" value="1" onclick="myFunction_sec(),onlyOne(this)" <?php if(isset($_POST['myCheck_prefer2'])) echo "checked='checked'"; ?>/>1
