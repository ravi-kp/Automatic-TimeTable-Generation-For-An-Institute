...
<body>
<?php
    $fh = fopen('course_from_db_even_sem.txt', 'w');
...
$result = mysqli_query($db,"SELECT course_name,no_of_student,semester,department,lab,preference,preffered_room,preffered_slot,division,lab_room FROM course where sem_type='even'");
